...
// Creamos las variables de los elementos que van a almacenar la info
...
prodForm.addEventListener("submit", (event) =>{
    ...
    const title = nameInput.value//tiene que tener el mismo npmbre que el form
...
formChat.addEventListener("submit", (e) => {
  ...
  socket.on("messages", (data) => {
    const html = data.map((user) => {
      ...
      <span style="color: gray">[${user.date}]:</span> 
